...
them. Batch reports also include a project-root retry command for failed,
blocked, or unfinished loops. If the original batch was explicitly approved for
execute mode, the retry command preserves `--allow-execute`.
